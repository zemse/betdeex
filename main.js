...
>>>>>>> 81ad3ea207c545c230def5f491955ea2443a762a
...
document.getElementById('betdeex-recharge-box').children[0].children[0].children[0].children[4].addEventListener('click', async()=>{
  ...
  esW3old.approve('0x'+env.betdeexAdress, amount, (err, result) => {
    ...
    console.log(result);
    document.getElementById('betdeex-recharge-box').children[0].children[0].children[0].children[4].innerText = 'Update ES again';
  });
});
